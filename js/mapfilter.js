const numeros = [2,3,4,2,1,5,6,7,8,9,10,21,54];
numeros.forEach(function(numero){
    console.log(numero*2)
});

//aplicar funcion a cada elemento de array - map 
...
//devolver el indice de valor coincidente 
const indice = numeros.findIndex(function(valor){
    return valor === 7;
});
console.log('Coinciden el 7 en el indice ...')
console.log(indice);
